  ...
  try {
    ...
    return new Promise(resolve => {
      ...
      img.onload = () => {
        ...
        ctx.fillStyle = '#111111'  // same as PDF header BLACK
...
/* ─────────────────────────────────────────────────── */
export async function generateSolicitudPdf({ poliza, vehiculos, personaFacturable, usuario, coberturas, logoUrl }) {
  ...
  // GGS logo — scaled to fit header, preserving aspect ratio
  let logoW = 0, logoH = 0
  if (logoDataUrl) {
